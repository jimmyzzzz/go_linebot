...
class PythonKernal(PercentageKernal):
	...
	def run_command(self, CMD):
		...
		(root_name, root, options) = RootOpt
		...
		run_call = IoRunCall(root, user_id, root_cmd, user_cmds)
		return_str = root.run(run_call, user_id, root_cmd, user_cmds)
		run_call.close()
		return return_str
